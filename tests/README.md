...
데스크톱 18%/82% 제목 레일과 좁은 화면의 세로 배치도 확인합니다. 이메일 단위 테스트는
18.75px/15.75px 제목·요약, 제목 굵기 525, 18px 등급 배지와 평가축 묶음의 줄바꿈 구조를
검사하며 소수 픽셀도 크기 규칙에 포함합니다. 심미성은 같은 크기의 전후 스크린샷으로 따로 평가합니다.
