...
| [`src/services/microsoft_learn.py`](../../../src/services/microsoft_learn.py) | 공식 문서 본문의 설명 있는 시각 자료 후보 추출 |
...
- 이미지는 공식 Learn 본문에서 추출한 설명 있는 PNG/JPEG/GIF만 허용하고 렌더러에서 HTTPS,
  Microsoft 호스트, 확장자, 비어 있지 않은 `alt`를 다시 검사합니다. 단건 2개, digest는 항목당
  1개·전체 4개를 넘기지 않으며 캡션과 원문 링크를 남깁니다.
