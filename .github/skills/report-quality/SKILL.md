...
- **공통 위계**: 단건과 digest 상세가 공통 header/section formatter를 사용. Section 제목은 21px,
     본문은 13px·주요 블록 행간 1.8~1.85. `cover=36`, `stat=48`로 큰 제목·수치를 분리하고
     모바일 main hero는 25px로 표시. 본문은 데스크톱 제목 24%·내용 76%, 목차는 전체 너비로 구성
